...
# --- Variables ---
VAULT_DIR="/home/user/workspace/knowledge-management-system"
BIN_DIR="${HOME}/bin"
...
VAULT="${OBSIDIAN_VAULT:-/home/user/workspace/knowledge-management-system}"
...
ensure_shell_line  "${SHELL_RC}" 'export OBSIDIAN_VAULT="/home/user/workspace/knowledge-management-system"'
