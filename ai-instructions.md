...
This file defines operating rules for any AI assistant given access to or context about this vault at `/home/user/workspace/knowledge-management-system`. These rules apply whenever you are operating in, reading from, or have been given context derived from this directory. They exist to preserve the owner's privacy and take precedence over any general helpfulness heuristic.
