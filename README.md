...
```
/home/user/workspace/knowledge-management-system
```
...
return {
  ...
  opts = {
    workspaces = {
      { name = "personal", path = vim.env.OBSIDIAN_VAULT or "/home/user/workspace/knowledge-management-system" },
    },
    daily_notes = {
      folder = "daily",
      date_format = "%Y-%m-%d",
...
|---|---|---|
| `OBSIDIAN_VAULT` | `/home/user/workspace/knowledge-management-system` | Absolute path to vault root; all `okm` subcommands resolve paths against this |
